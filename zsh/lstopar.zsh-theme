...
ZSH_HIGHLIGHT_STYLES[alias]=fg=$CODE_YELLOW,bold
ZSH_HIGHLIGHT_STYLES[builtin]=fg=$CODE_YELLOW,bold
ZSH_HIGHLIGHT_STYLES[function]=fg=$CODE_BLUE,bold
ZSH_HIGHLIGHT_STYLES[command]=fg=$CODE_PURPLE,bold
