...
# directories
COLOR_DIR=$COLOR_BLUE_ALT';'$EFFECT_BOLD
...
if [[ ${EUID} == 0 ]] ; then
    ...
    PS1='${debian_chroot:+($debian_chroot)}\[\e['$COLOR_BLUE_ALT'm\]\u@\h \[\e['$COLOR_WHITE'm\]\W \[\e['$COLOR_BLUE_ALT'm\]$\[\e[00m\] '
fi
